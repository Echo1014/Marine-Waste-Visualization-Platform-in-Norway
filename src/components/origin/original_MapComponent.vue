...
export default {
  ...
  methods: {
    ...
    setGeoData() {
      axios
        .get('http://47.108.61.203:8081/originalGivedata/')
        .then((response) => {
    ...
    setScatterTypeData(selectedType) {
      ...
      axios
        .get('http://47.108.61.203:8081/originalGiveScattertypeData/', data)
        .then((response) => {
    ...
    setHeatTypeData(selectedType) {
      ...
      axios
        .get('http://47.108.61.203:8081/originalGiveHeatmaptypeData/', data)
        .then((response) => {
          console.log('display typeData=', response.data)
    ...
    setTimeHeatmapData() {
      axios
        .get('http://47.108.61.203:8081/originalGiveTimeHeatmapData/')
        .then((response) => {
