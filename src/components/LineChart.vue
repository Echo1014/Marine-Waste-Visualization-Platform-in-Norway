...
export default {
  ...
  methods: {
    async setLinetData() {
      try {
        const activitiesResponse = await axios.get('http://47.108.61.203:8081/activities/')
        const missActivitiesResponse = await axios.get('http://47.108.61.203:8081/missActivities/')
